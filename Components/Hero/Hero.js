    ...
    <div className={styles.hero}>
      <div className={styles.text}>
        ...
        <p className={styles.hero_body}>
          ...
          with and shapes our way of experiencing the world. This curiosity has
          led me to a career in web development, where I hope to put my passion
          and curiosity to use laying down the next stages of online
          infrastructure.
        </p>
      </div>
      <div />
